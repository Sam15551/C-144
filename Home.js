...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state={
      movieDetails: {},
      ngrok_url:"https://934f-2406-7400-43-881-fdd4-5c75-3e0c-47ba.in.ngrok.io"
    }
  }
...
dislikedMovie =()=>{
  const url = this.state.ngrok_url + "/disliked"
  axios.get(url)
  .then((response) => {
    this.getmovie()  
    })
            ...
            <View style={styles.subContainer}>
              ...
              <View style={{flex:0.15}}>
                 {/*Add the components to show the movie name and other details ( release date & duration) below*/}
                  <View style={styles.detailsContainer}>
                    ...
                    <Text style={styles.subtitle}>{release_date.split("-")[0]}|{duration}mins</Text>
                  </View>
              ...
              <View style={styles.iconButtonContainer}>
                ...
                <TouchableOpacity onPress={this.likedMovie}>
                  <Image style={styles.iconImage} source={require("../assets/like.png")}></Image>
                </TouchableOpacity>
